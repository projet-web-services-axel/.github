...
Depuis un compte utilisateur, permettre l'inscription aux tournois &rarr; envoie un message gRPC au service profil utilisateur.  
Suivre les places restantes d'un tournoi en temps réel.

## Service notification

Micro services en Golang, utilisera un server-sent events.
Reçoit un évènement du service profil utilisateur &rarr; envoie des notifications aux joueurs par rapport aux tournois inscrits.  
...
Reçoit ses informations par le service tournoi grâce à gRPC &rarr; envoie ensuite un évènement pour le service notification.
